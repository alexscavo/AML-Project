...
_C.TRAIN.AUGMENTATION = CN()
_C.TRAIN.AUGMENTATION.ENABLE = False
_C.TRAIN.AUGMENTATION.PROBABILITY = 0.5
_C.TRAIN.AUGMENTATION.TECHNIQUES = CN()
_C.TRAIN.AUGMENTATION.TECHNIQUES.HORIZONTAL_FLIP = False
_C.TRAIN.AUGMENTATION.TECHNIQUES.GAUSSIAN_BLUR = False
_C.TRAIN.AUGMENTATION.TECHNIQUES.RANDOM_CROP = False
_C.TRAIN.AUGMENTATION.TECHNIQUES.GAUSSIAN_NOISE = False
_C.TRAIN.AUGMENTATION.TECHNIQUES.COLOR_JITTER = False
_C.TRAIN.DACS = CN()
_C.TRAIN.DACS.ENABLE = False
_C.TRAIN.DACS.THRESHOLD = 0.968
_C.TRAIN.GAN = CN()
_C.TRAIN.GAN.ENABLE = False
_C.TRAIN.GAN.MULTI_LEVEL = False
_C.TRAIN.FDA = CN()
_C.TRAIN.FDA.ENABLE = False
